<template>
  <transition
    ...
    <div class="container offScreen">
        ...
        <div class="rightText">
          Фигурный раскрой листового металлопроката(технологический процесс разрезания листа на отдельные детали или заготовки) производится плазмотроном или газокислородным резаком.Опция с ротационной головой так же позволяет выполнять разделку кромок различной конфигурации под сварку, типа А, V, Y
        </div>
    </div>
  </transition>
</template>
